...
from superos import HEROKU_APP, bot
...
async def _(event):
    ...
    if HEROKU_APP is not None:
        HEROKU_APP.process_formation()["superos"].scale(0)
    else:
        sys.exit(0)


CmdHelp("ρωя τοℓѕ").add_command(
  "restart", None, "Restarts your superos. Reѕtarting Bot may result in better functioning of bot when its laggy"
).add_command(
