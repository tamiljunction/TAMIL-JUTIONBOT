...
@LEGENDBOT.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@LEGENDBOT.on(admin_cmd(pattern="cos ?(.*)"))
@LEGENDBOT.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@LEGENDBOT.on(admin_cmd(pattern="tan ?(.*)"))
@LEGENDBOT.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@LEGENDBOT.on(admin_cmd(pattern="cosec ?(.*)"))
@LEGENDBOT.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@LEGENDBOT.on(admin_cmd(pattern="sec ?(.*)"))
@LEGENDBOT.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@LEGENDBOT.on(admin_cmd(pattern="cot ?(.*)"))
@LEGENDBOT.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@LEGENDBOT.on(admin_cmd(pattern="square ?(.*)"))
@LEGENDBOT.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@LEGENDBOT.on(admin_cmd(pattern="cube ?(.*)"))
@LEGENDBOT.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
