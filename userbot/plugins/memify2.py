...
@LEGEND.on(admin_cmd(pattern=r"mmf ?(.*)"))
@LEGEND.on(sudo_cmd(pattern=r"mmf ?(.*)", allow_sudo=True))
async def handler(event):
    ...
    file = await borg.download_media(reply_message, Var.TMP_DOWNLOAD_DIRECTORY)
